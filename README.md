...
#### 自定义横向日期选择控件(Added by Miwi)
适用于支持抽象节点的基础库1.9.6以上版本
基础库1.9.6以下版本请切换TAG “hds-no-componentGenerics”
![](https://linmiwi.github.io/assets/fix_top_wrap/horizontal-scroll-day.gif)
#### 折线图
